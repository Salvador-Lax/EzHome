...
<html>
    ...
    <body>
        ...
        <main id="contactarCita">
            <div class="container-fluid">
				<div class="d-flex justify-content-center">
					<%
						if (session.getAttribute("errorContactarCita") != null) {
							%><script>alert("<%=session.getAttribute("errorContactarCita")%>");</script><% 
                            session.setAttribute("errorContactarCita", null);
						};
					%>
					<form method="post">
						<h2 class="text-center"><u>Contactar por Email</u></h2>
