        ...
        <main id="contacto">
            <div class="container-fluid">
				<div class="d-flex justify-content-center">
					<%
						if (session.getAttribute("errorContactar") != null) {
							%><script>alert("<%=session.getAttribute("errorContactar")%>");</script><% 
                            session.setAttribute("errorContactar", null);
						};
					%>
                    <%
						if (session.getAttribute("mensajeContactar") != null) {
							%><script>alert("<%=session.getAttribute("mensajeContactar")%>");</script><% 
                            session.setAttribute("mensajeContactar", null);
						};
					%>
					<form method="post">
						<h2 class="text-center"><u>Contacto</u></h2>
                        <h5 class="text-center pt-3">Indique sus datos y un mensaje</h5>
                        <div class="row g-2">
						...
						<div class="form-floating">
                            ...
                            <label for="asunto">Especifique asunto</label>
						<div>

                        <div class="form-floating">
							<textarea rows="10" cols="50" name="mensaje" class="form-control" placeholder="mensaje"></textarea>
                            <label for="mensaje">Especifique el mensaje a enviar</label>
						<div>
