...
<html lang="es">
	...
	<body>
		...
		<main id="eliminarInmueble">
			<div class="container-fluid">
				<div class="d-flex justify-content-center">
					<%
						if (session.getAttribute("errorEliminarInmueble") != null) {
							%><script>alert("<%=session.getAttribute("errorEliminarInmueble")%>");</script><% 
							session.setAttribute("errorEliminarInmueble", null);
						};
					%>
					<form method="post">
						<h2 class="text-center"><u>Eliminar Inmueble del Catalogo</u></h2>
						<div class="text-center">
							<label for="eliminar">¿Esta seguro que desea eliminar esta publicación?<br>De ser así, escriba este código: <%=session.getAttribute("codigoEliminar")%></label>
